...
public class ExportImportChronological {

	@Test
	public void test() throws Exception {
		DateFormat format = new SimpleDateFormat("yyyy-MM-dd");
		BasicCv cv = new Chronological("testChrono", "6985454555", "212255", "Ioaninnon 121", "adsa@gmoil.com");
		...
		cv.latex();
		BasicCv cv2 = ImportLatexhelper.readLatex("testChrono.tex");
	...
	public void test2() throws Exception {
		...
		cv.export();
		BasicCv cv2 = ImportHelper.readText("testChrono.txt");
